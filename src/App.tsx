...
function App() {
  ...
  const [view, setView] = useState<'dashboard' | 'account' | 'auth'>('dashboard');
  ...
  useEffect(() => {
    if (view === 'dashboard') {
      const resourcesSection = document.getElementById('resources-section');
      if (resourcesSection) {
        // Using a small timeout to ensure the element is available after the view change
  ...
  return (
    <div className="min-h-screen">
      ...
      <Header 
        ...
        onSearchChange={view === 'dashboard' ? handleSearchChange : undefined}
        onSearchSubmit={view === 'dashboard' ? handleSearchSubmit : undefined}
        ...
        {view === 'dashboard' && (
          <>
            ...
            <section className="relative overflow-hidden text-white">
              <div className="relative z-10 max-w-9xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto">
                  <div className="group bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2">
                    <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                      <Palette className="w-6 h-6 text-white" />
                    </div>
                    <h3 className="text-xl font-semibold mb-2 text-black">800+ Resources</h3>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8">
                  <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="hidden lg:block xl:w-80 lg:w-72 lg:sticky top-24 self-start">
                      <FilterSidebar
